...
public class AStar
{
    ...
    public void Init(int x, int z)
    {
        ...
        mPathChecked = new GridPos[mTotal];
        for (int i = 0; i < mZ; i++)
        {
            for (int j = 0; j < mX; j++)
            {
    ...
    public void CheckPathDir(GridPos posEnd)
    {
        if (posEnd == null)
            return;
